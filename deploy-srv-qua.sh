...
SERVER="srvdockerqua" # amasinta
# SERVER="10.160.3.1"
PROJECTFOLDER_LOCAL="mystic_navalria_website-local"
PROJECTFOLDER_REMOTE="mystic_navalria_website-qua"
...
TIMESTAMP=$(date "+%Y-%m-%d %H:%M:%S")
echo "[$TIMESTAMP] --- Fim do deploy QUALIDADE ---" >> "$LOG_FILE"

echo
echo "Deploy Ambiente QUALIDADE em SRVDOCKERLAB [ 10.160.3.1 ] concluído com sucesso!"
echo