...
SERVER="srvdockerlab" # amasinta
# SERVER="10.160.3.1"
PROJECTFOLDER_LOCAL="mystic_navalria_website-local"
PROJECTFOLDER_REMOTE="mystic_navalria_website-dev"
...
echo
echo "Deploy Ambiente DESENVOLVIMENTO em SRVDOCKERLAB [ 10.160.3.1 ] concluído com sucesso!"
echo