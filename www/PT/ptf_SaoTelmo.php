...
<html>
 	<head>
		<title>Navalria | São Telmo</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE REPARAÇÃO <span class="sub-title">/ SÃO TELMO</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_SantaCristina"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_RiaVigo"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/SaoTelmo/01.jpg" alt="São Telmo" >
					</div>
				</div></div>
             ...
             <div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/SaoTelmo/02.jpg" alt="São Telmo" >
					</div>
				</div></div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>A Navalria tem também experiência na reparação de barcos turísticos, como é o caso do São Telmo, um barco Rabelo, propriedade da  Via Douro, que foi aumentado na Navalria.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>COMPRIMENTO: 37 m</li>
					 <br>
						<li>BOCA: 5,6 m</li>
						<br>
						<li>CALADO: 1,6 m</li>
						<br>
						<li>DESLOCAMENTO: 60 t</li>
						<br>
					</ul>
				</div>
			</div>	
