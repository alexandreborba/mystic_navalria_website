...
<html>
 	<head>
		<title>Navalria | Viking Torgil</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO EM CURSO <span class="sub-title">/ VIKING  TORGIL</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_Viking_Hemming"></a>
					</li>
					<li>
		...
		<!-- PORTFOLIO ITEM -->
				...
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Viking_Torgil/Torgil01.jpg" alt="Viking  Torgil" >
					</div>
				</div></div>
                <div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Viking_Torgil/Torgil02.jpg" alt="Viking  Torgil" >
					</div>
				</div></div>
                <div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Viking_Torgil/Torgil03.jpg" alt="Viking  Torgil" >
					</div>
				</div></div>
                <div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Viking_Torgil/Torgil04.jpg" alt="Viking  Torgil" >
					</div>
				</div></div>
		</div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>O Viking Torgil, a par com o Viking Hemming, é um dos dois  mais recentes projetos da Navalria para a Douro Azul, e deverão estar concluídos no início de 2014.</p>
              </div>
			</div>
