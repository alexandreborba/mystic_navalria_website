...
<html>
 	<head>
		<title>Navalria | Viking Douro II e Viking Porto</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO <span class="sub-title">/ VIKING HEMMING E VIKING TORGIL</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_PreiaMar"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_Amavida"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Viking/Viking01.jpg" alt="Viking Douro II e Viking Porto" >
					</div>
				</div></div>
                ...
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/Viking/Viking03.jpg" alt="Viking Douro II e Viking Porto" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Viking/Viking04.jpg" alt="Viking Douro II e Viking Porto" ></div></div></td>
                        </tr>
                        </table>
				</div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Estes dois navios hotel são os mais recentes projetos da Navalria para a Douro Azul, e deverão estar concluídos no início de 2014.</p>
              </div>
			</div>
