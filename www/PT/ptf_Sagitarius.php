...
<html>
 	<head>
		<title>Navalria | Sagittarius</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE REPARAÇÃO <span class="sub-title">/ SAGITTARIUS</span></h1>
				<ul class="portfolio-pagination">
				  <li>
						<a class="pag-prev" href="ptf_PortTejo"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_Annerdiep"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Sagitarius/01.jpg" alt="Sagittarius" >
					</div>
				</div></div>
                ...
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/Sagitarius/02.jpg" alt="Sagittarius" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Sagitarius/03.jpg" alt="Sagittarius" ></div></div></td>
                        </tr>
                        </table>
			</div>
                ...
                <div class="blog-item m-bot-25">
						<table width="100%" cellpadding="0px" cellspacing="0px" >
                       <tr> <td align="left"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Sagitarius/08.jpg" alt="Sagittarius" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Sagitarius/09.jpg" alt="Sagittarius" ></div></div></td>
                        </tr>
                        </table>
			</div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Ao longo dos últimos 8 anos, o navio de pesca Sagittarius, propriedade da empresa Testas e Cunhas, Lda, tem sido totalmente reparado nos estaleiros da Navalria.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>COMPRIMENTO: 28 m</li>
					 <br>
						<li>BOCA: 7,5 m</li>
						<br>
						<li>CALADO: 4,6 m</li>
						<br>
						<li>DESLOCAMENTO: 330 t</li>
						<br>
					</ul>
				</div>
			</div>	
