	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO EM CURSO <span class="sub-title">/ NAVIO-MUSEU SANTO ANDRÉ</span></h1>
	...
	<div class="container clearfix">
		...
		<div class="blog-item m-bot-25">
		  <div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/SantoAndre_Jul2020.jpg" alt=""/></div>
				</div></div>
                
                <div class="blog-item m-bot-25"></div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>A intervenção da Navalria na requalificaçáo do navio-museu abrange todos espaços do navio, com particular destaque para os porões, as áreas de alojamento, o parque do guincho de pesca, a casa das máquinas, a balaustrada exterior, o convés, os mastros e a ponte, para além da pintura total, docagem e alagem, e a renovação de toda a componente elétrica e sistemas do navio, entre outros. Este processo é parte integrante de uma requalificação mais alargada do Navio-Museu Santo André.</p>
              </div>
			</div>
