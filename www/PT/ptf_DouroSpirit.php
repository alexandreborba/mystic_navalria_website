...
<html>
 	<head>
		<title>Navalria | Douro Spirit</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE CONSTRUÇÃO <span class="sub-title">/ DOURO SPIRIT</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_QueenIsabel"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_ProaDouro_Portuense"></a>
					</li>
				</ul>
			</div>	
		</div>
        ...
        <div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Dourospirit/05.jpg" alt="Douro Spirit" >
					</div>
				</div></div>
         ...
         <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/Dourospirit/07.jpg" alt="Douro Spirit" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Dourospirit/02.jpg" alt="Douro Spirit" ></div></div></td>
                        </tr>
                        </table>
                        </div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Dourospirit/03.jpg" alt="Douro Spirit" >
					</div>
				</div></div>
				...
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Dourospirit/06.jpg" alt="Douro Spirit" >
					</div>
				</div></div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Construído em 2011, o Douro Spirit foi o primeiro navio hotel construído pela Navalria para a Douro Azul. </p>
						<p>É um navio inovador e conta com um motor propulsor que permite diminuir as emissões de CO<sub>2</sub> da embarcação, iluminação por LED e ainda pré-aquecimento da água de banhos por permutador de calor, utilizando a água de arrefecimento dos motores.</p>
</div>
			</div>
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>PROJETO: CMT Engineering Ldt. <br>
					   Ship Design</li><br>
						<li>COMPRIMENTO FORA-FORA: 79,50 m</li><br>
						<li>COMPRIMENTO ENTRE PERPENDICULARES: 72,90 m</li><br>
						<li>BOCA MLD: 11,00 m</li><br>
                        <li>BOCA EXT.: 11,40 m</li><br>
                        <li>PONTAL MLD: 3,30 m</li><br>
                        <li>CALADO MAX. (Design slwl): 1,80 m</li><br>
                        <li>CALADO MIN. (Operacional): 1,60 m</li><br>
                        <li>CAPACIDADE: Passageiros - 65 cabines; Tripulação - 12 cabines</li><br>
					</ul>
				</div>
			</div>	
