	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE REPARAÇÃO <span class="sub-title">/ PROMETEU</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_ProaDouro_Portuense"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_Noruega"></a>
					</li>
				</ul>
			</div>	
		</div>
	...
	<div class="container clearfix">
		...
		<!-- PORTFOLIO ITEM -->
			<div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/Prometeu/01.jpg" alt="Prometeu" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Prometeu/02.jpg" alt="Prometeu" ></div></div></td>
                        </tr>
                        </table>
			</div>
<div class="blog-item m-bot-25">
						<table width="100%" cellpadding="0px" cellspacing="0px" >
                       <tr> <td align="left" width="306px"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Prometeu/03.jpg" alt="Prometeu" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Prometeu/04.jpg" alt="Prometeu" ></div></div></td>
                        </tr>
                        </table>
			</div>
            <div class="blog-item m-bot-25">
						<table width="100%" cellpadding="0px" cellspacing="0px" >
                       <tr> <td align="left" width="306px"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Prometeu/05.jpg" alt="Prometeu" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Prometeu/06.jpg" alt="Prometeu" ></div></div></td>
                        </tr>
                        </table>
			</div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Ao longo dos últimos 15 anos, o navio rebocador Prometeu, da Administração do Porto Douro Leixões, tem sido totalmente reparado nos estaleiros da Navalria.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>COMPRIMENTO: 30 m</li><br>
						<li>BOCA: 8 m</li>
						<br>
						<li>CALADO: 6 m</li>
						<br>
						<li>DESLOCAMENTO: 350 t</li>
						<br>
