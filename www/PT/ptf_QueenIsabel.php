...
<html>
 	<head>
		<title>Navalria | Queen Isabel</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE CONSTRUÇÃO <span class="sub-title">/ QUEEN ISABEL</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_Amavida"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_DouroSpirit"></a>
					</li>
				</ul>
			</div>	
		</div>
	...
	<div class="container clearfix">
		...
		<!-- PORTFOLIO ITEM -->
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/QueenIsabel_AmaVida/03.jpg" alt="Queen Isabel" >
					</div>
				</div></div>
                
                <div class="blog-item m-bot-25">
                <table width="100%" cellpadding="0px" cellspacing="0px" >
                       <tr> <td align="left"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/QueenIsabel_AmaVida/01.jpg" alt="Queen Isabel" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/QueenIsabel_AmaVida/05.jpg" alt="Queen Isabel" ></div></div></td>
                        </tr>
                        </table>
			</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/QueenIsabel_AmaVida/10.jpg" alt="Queen Isabel" >
					</div>
				</div>
             </div>
...
<div class="blog-item m-bot-25">
                <table width="100%" cellpadding="0px" cellspacing="0px" >
                       <tr> <td align="left" width="306px"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/QueenIsabel_AmaVida/07.jpg" alt="Queen Isabel" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right">&nbsp;</td>
                        </tr>
                        </table>
...
<!-- SIDEBAR -->
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				<div class="content-container-white">
					<h3 class="title-widget"><span class="bold">DESCRIÇÃO</span> DO PROJETO</h3>
				</div>
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>O Queen Isabel foi um dos dois navios construídos para a Douro Azul durante o ano de 2012. Conta com uma piscina aquecida, localizada no convés solar, ginásio, massagens terapêuticas, spa, entre outras comodidades.</p>
						<p>O navio é alimentado por 155 m<sup>2</sup> de painéis solares fotovoltaicos, e os motores são energeticamente eficientes.</p>
              </div>
			</div>
		...
		<!-- WIDGET -->
			<div class="sidebar-item  m-bot-25">
				<div class="content-container-white">
					<h3 class="title-widget"><span class="bold">DETALHES</span> DO PROJETO</h3>
				</div>
				<div class="under-box-bg"></div>
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>PROJETO: CMT Engineering Ldt. <br>
					   Ship Design</li><br>
						<li>COMPRIMENTO FORA-FORA: 79,85 m </li><br>
						<li>COMPRIMENTO ENTRE PERPENDICULARES: 72,90 m</li><br>
						<li>BOCA MLD: 11,00 m</li><br>
                        <li>BOCA EXT.: 11,40 m</li><br>
                        <li>PONTAL: 3,20 m</li><br>
                        <li>CALADO MAX.: 1,80 m</li><br>
                        <li>CALADO AÉREO (a 1,5 m de calado): <br>
                      7,20 m</li><br>
                        <li>CAPACIDADE: Passageiros - 59 cabines  Tripulação - 13 cabines</li><br>
					</ul>
				</div>
			</div>	
