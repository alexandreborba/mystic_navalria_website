...
<html>
 	<head>
		<title>Navalria | Quem Somos</title>
		<meta charset=utf-8 >
...
<div class="row">
				...
				<div class="row">
					<div class="in-sixteen in-columns">
						...
						<p><img src="images/quemSomos.jpg" width="908" height="250"/></p>
                        <p>
							A Navalria é um estaleiro naval com a atividade de construção e reparação de embarcações. Com mais de 45 anos atividade, a empresa já passou por diversas fases de alterações significativas dos mercados, tendo conseguido sobreviver às mais diversas dificuldades e adversidades do meio envolvente e, mais concretamente, do seu setor de atuação, a indústria naval.</p>
							<p>Desta forma, a empresa assumiu-se como uma <strong>unidade de interesse estratégico para a região onde se encontra</strong> – Aveiro – através da manutenção do reconhecimento dos seus clientes.</p>
							<p>A Navalria tem vindo a mudar paradigmas de gestão, passando a reger-se por prioridades fundamentais para a continuidade de qualquer organização:<i></i></p>
							<ul class="styled-list style-4">
							  <li>A aposta nas pessoas - só com quadros motivados e qualificados é possível obter elevados níveis de produtividade e criação de valor </li>
                              <li>A qualidade dos serviços disponibilizados ao cliente</li>
					  </ul>
							<p>Depois de muitos anos a exercer exclusivamente a atividade de reparação naval, desde 2009 a Navalria iniciou e tem vindo a complementar a atividade com a construção de embarcações em aço. Atualmente, conta já com algumas construções emblemáticas no seu portefólio e é já um dos principais estaleiros navais em Portugal. A Navalria é ainda o único estaleiro naval português que integra a lista europeia de estaleiros licenciados para o desmantelamento e reciclagem de navios fora de uso.</p>
							<p><strong>A capacidade demonstrada em todos os  projetos tem contribuído para ganhar a confiança dos nossos clientes</strong> e assegurar a continuidade e expansão do negócio de construção naval.</p>
					</div>
				...
				<div class="row">
					 <div class="in-one-third in-column">
						...
						<p><img src="images/quemSomos_pessoas.jpg"/> </p>
					</div>
					<div class="in-two-third in-column">
						<p>Com cerca de 50 colaboradores, a aposta da Navalria nas pessoas e no seu desenvolvimento pessoal e profissional tem permitido à empresa melhorar significativamente o seu desempenho, com a robustez e confiança necessárias para operar num setor com muitos desafios para superar.</p>
					<p><strong>É assente nesta equipa que a Navalria encara o futuro com otimismo e confiança.</strong></p>
					</div>
