...
<html>
 	<head>
		<title>Navalria | Proa Douro e Portuense</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE CONSTRUÇÃO <span class="sub-title">/ PROA DOURO E PORTUENSE</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_DouroSpirit"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_Prometeu"></a>
					</li>
				</ul>
			</div>	
		</div>
	...
	<div class="container clearfix">
		...
		<!-- PORTFOLIO ITEM -->
			<div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/ProaDeP/01.jpg" alt="Proa Douro e Portuense" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/ProaDeP/02.jpg" alt="Proa Douro e Portuense" ></div></div></td>
                        </tr>
                        </table>
			</div>
            ...
            <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/ProaDeP/rabelos_1.jpg" alt="Proa Douro e Portuense" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right">&nbsp;</td>
                        </tr>
                        </table>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Construídos para a empresa Via Douro, estas duas embarcações, ao contrário dos rabelos tradicionais, são construídas em aço. Esta construção assegura o cumprimento dos requisitos de resistência ao fogo e faz com que a sua reparação seja mais económica e rápida.</p>
						<p>Por outro lado, a construção em aço torna os barcos mais leves e, por isso, mais ecológicos, uma vez que diminuem o consumo de combustível.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>PROJETO: CNV Naval Architects </li><br>
						<li>COMPRIMENTO TOTAL: 19,00 m</li><br>
						<li>COMPRIMENTO EP.: 15,00 m</li><br>
						<li>BOCA EXT.: 4,00 m </li><br>
                        <li>CALADO MAX. (Design slwl): 0,60 m</li>
                        <br>
                        <li>CAPACIDADE: 45  passageiros</li><br>
					</ul>
				</div>
			</div>	
