...
<html>
 	<head>
		<title>Navalria | Ria de Vigo</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE REPARAÇÃO <span class="sub-title">/ RIA DE VIGO</span></h1>
				<ul class="portfolio-pagination">
				  <li>
						<a class="pag-prev" href="ptf_SaoTelmo"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_PreiaMar"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/RiaVigo/01.jpg" alt="Ria de Vigo" >
					</div>
				</div></div>
                ...
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/RiaVigo/02.jpg" alt="Ria de Vigo" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/RiaVigo/03.jpg" alt="Ria de Vigo" ></div></div></td>
                        </tr>
                        </table>
					</div>
				...
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/RiaVigo/04.jpg" alt="Ria de Vigo" >
					</div>
				</div></div>
                ...
                <div class="blog-item m-bot-25">
						...
						<table width="100%" cellpadding="0px" cellspacing="0px" >
                       <tr> <td align="left" width="306px"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/RiaVigo/05.jpg" alt="Ria de Vigo" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/RiaVigo/06.jpg" alt="Ria de Vigo" ></div></div></td>
                        </tr>
                        </table>
					</div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>O Ria de Vigo, um reboque de alto mar propriedade da Remolcanosa é reparado na Navalria há mais de 5 anos.</p>
              </div>
			</div>
