...
<html>
 	<head>
		<title>Navalria | Areia Mar</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO >DE REPARAÇÃO<span class="sub-title" / AREIA MAR</span></h1>
				<ul class="portfolio-pagination">
				  <li>
						<a class="pag-prev" href="ptf_CaleAveiro"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_PortTejo"></a>
					</li>
				</ul>
			</div>	
		</div>
	...
	<div class="container clearfix">
		...
		<!-- PORTFOLIO ITEM -->
			...
			<table width="100%" cellpadding="0px" cellspacing="0px" >
					...
					<div class="view view-first"><img src="images/portfolio/AreiaMar/01.jpg" alt="Areia Mar" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/AreiaMar/02.jpg" alt="Areia Mar" ></div></div></td>
                        </tr>
                        </table>
			</div>
            <div class="blog-item m-bot-25">
			<table width="100%" cellpadding="0px" cellspacing="0px" >
                       <tr> <td align="left" width="306px"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/AreiaMar/03.jpg" alt="Areia Mar" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/AreiaMar/04.jpg" alt="Areia Mar" ></div></div></td>
                        </tr>
                        </table>
					</div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>O Areia Mar é uma draga de sucção, propriedade de Manuel Maria Almeida e Silva. Esta embarcação é reparada na Navalria há 12 anos.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>COMPRIMENTO: 68 m</li>
					 <br>
						<li>BOCA: 12 m</li>
						<br>
						<li>CALADO: 5 m</li>
						<br>
						<li>DESLOCAMENTO: 700 t</li>
						<br>
