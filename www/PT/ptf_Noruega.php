	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE REPARAÇÃO <span class="sub-title">/ NORUEGA</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_Prometeu"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_Lisbonense"></a>
					</li>
				</ul>
			</div>	
		</div>
	...
	<div class="container clearfix">
		...
		<!-- PORTFOLIO ITEM -->
          <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/Noruega/01.jpg" alt="Noruega" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Noruega/02.jpg" alt="Noruega" ></div></div></td>
                        </tr>
                        </table>
				</div>
                ...
                <div class="blog-item m-bot-25">
						<table width="100%" cellpadding="0px" cellspacing="0px" >
                       <tr> <td align="left" width="306px"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Noruega/03.jpg" alt="Noruega" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right">&nbsp;</td>
                        </tr>
                        </table>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Desde há 10 anos que a Navalria efetua a manutenção geral deste navio de Investigação de Pesca, propriedade do Instituto Português de Investigação em Pescas.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>COMPRIMENTO: 50 m</li>
					 <br>
						<li>BOCA: 10 m</li>
						<br>
						<li>CALADO: 6,5 m</li>
						<br>
						<li>DESLOCAMENTO: 600 t</li>
						<br>
					</ul>
				</div>
			</div>	
