		  ...
		  <div class="container clearfix">
				<div class="sixteen columns ">
						<div id="logo-container">	
							...
							<li><a id="flickr-link" title="Português" href="estaleiro_Elevador"></a></li>
							<li><a id="vimeo-link" title="English" href="../EN/shipyard_Shiplift"></a></li>
							<li><a id="rss-link" title="Français" href="../FR/LeChantier_Elevateur"></a></li>
						</ul>
				</div>
			</div>
			<div class="container clearfix">
       ...
       <div class="in-sixteen in-columns"><p><h1>O Estaleiro</h1></p>
				...
				<div class="row">
					...
					<div class="in-one-third in-column">
						<P><h4>Elevador de navios</h4>
						</P>
					  <p><strong>TRANSFERIDOR:</strong> 24 m e 4 planos de arrumação <br>
					    de navios<br/>
                           <strong> COMPRIMENTO:</strong> 36 m<br/>
                            <strong>BOCA:</strong> 8 m<br/>
                            <strong>CALADO:</strong> 4,6 m<br/>
                            <strong>CAPACIDADE DE SUSTENTAÇÃO:</strong> 300 t
