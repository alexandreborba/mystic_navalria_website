		  ...
		  <div class="container clearfix">
				<div class="sixteen columns ">
						<div id="logo-container">	
							...
							<li><a id="flickr-link" title="Português" href="estaleiro_DocaSeca"></a></li>
							<li><a id="vimeo-link" title="English" href="../EN/shipyard_DryDoc"></a></li>
							<li><a id="rss-link" title="Français" href="../FR/LeChantier_CaleSeche"></a></li>
						</ul>
				</div>
			</div>
			<div class="container clearfix">
       ...
       <div class="in-sixteen in-columns"><p><h1>O Estaleiro</h1></p>
				...
				<div class="row">
					...
					<div class="in-one-third in-column">
						<P><h4>Doca seca</h4></P>
						<p>
                            <strong>COMPRIMENTO:</strong> 104 m<br/>
                            <strong>BOCA:</strong> 18 m<br/>
                            <strong>CALADO:</strong> 6,5 m<br/>
                            <strong>CAPACIDADE DE SUSTENTAÇÃO:</strong> 3 500 t
