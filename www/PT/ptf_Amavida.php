	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE CONSTRUÇÃO <span class="sub-title">/ AMAVIDA</span></h1>
				<ul class="portfolio-pagination">
				  <li>
						<a class="pag-prev" href="ptf_Viking_Torgil"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_QueenIsabel"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/QueenIsabel_AmaVida/11.jpg" alt="AmaVida" >
					</div>
				</div></div>
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/QueenIsabel_AmaVida/06.jpg" alt="AmaVida" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/QueenIsabel_AmaVida/09.jpg" alt="AmaVida" ></div></div></td>
                        </tr>
                        </table>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>O AmaVida foi um dos dois navios construídos para a Douro Azul durante o ano de 2012. Conta com uma piscina aquecida, localizada no convés solar, ginásio, massagens terapêuticas, spa, entre outras comodidades.</p>
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>PROJETO: CMT Engineering Ldt. <br>
                      ...
                      7,20 m</li><br>
                        <li>CAPACIDADE: Passageiros - 54 cabines  Tripulação - 13 cabines</li><br>
					</ul>
				</div>
			</div>	
