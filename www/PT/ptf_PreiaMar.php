...
<html>
 	<head>
		<title>Navalria | Preia-Mar</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE REPARAÇÃO <span class="sub-title">/ PREIA-MAR</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_RiaVigo"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_Viking_Hemming"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/PreiaMar/01.jpg" alt="Preia Mar" >
					</div>
				</div></div>
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/PreiaMar/02.jpg" alt="Preia Mar" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/PreiaMar/03.jpg" alt="Preia Mar" ></div></div></td>
                        </tr>
                        </table>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>O Preia-Mar é uma lancha de fiscalização, propriedade da Marinha Portuguesa, cujos trabalhos de revisão e certificação são também efetuados pela Navalria.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>COMPRIMENTO: 14 m</li>
					 <br>
						<li>BOCA: 3,5 m</li>
						<br>
						<li>CALADO:1,2 m</li>
						<br>
						<li>DESLOCAMENTO: 25 t</li>
						<br>
					</ul>
				</div>
			</div>	
