...
<html>
 	<head>
		<title>Navalria | Annerdiep</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE REPARAÇÃO <span class="sub-title">/ ANNERDIEP</span></h1>
				<ul class="portfolio-pagination">
				  <li>
						<a class="pag-prev" href="ptf_Sagitarius"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_SantaCristina"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Annerdiep/01.jpg" alt="Annerdiep" >
					</div>
				</div></div>
                ...
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/Annerdiep/02.jpg" alt="Annerdiep" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Annerdiep/03.jpg" alt="Annerdiep" ></div></div></td>
                        </tr>
                        </table>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Desde 2003 que a empresa Intership Navegation.co efetua as reparações do cargueiro Annerdiep nas instalações da Navalria.</p>
              </div>
			</div>
