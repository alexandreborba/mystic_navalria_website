...
<html>
 	<head>
		<title>Navalria | Viking Hemming</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO EM CURSO <span class="sub-title">/ VIKING HEMMING </span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_PreiaMar"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_Viking_Torgil"></a>
					</li>
				</ul>
			</div>	
		</div>
	...
	<div class="container clearfix">
		...
		<!-- PORTFOLIO ITEM -->
			 <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/Viking_Hemming/Hemming306x291c.jpg" alt="Viking Hemming" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Viking_Hemming/Hemming306x291d.jpg" alt="Viking Hemming" ></div></div></td>
                        </tr>
                        </table>
				</div>
                <div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Viking_Hemming/Hemming638x291.jpg" alt="Viking Hemming" >
					</div>
				</div></div>
                ...
                <div class="blog-item m-bot-25">
                	<table width="100%" cellpadding="0px" cellspacing="0px" >
                       <tr> <td align="left"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Viking_Hemming/Hemming306x291b.jpg" alt="Viking Hemming" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Viking_Hemming/Hemming306x291.jpg" alt="Viking Hemming" ></div></div></td>
                        </tr>
                        </table>
				</div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>O Viking Hemming, a par com o Viking Torgil, é um dos dois  mais recentes projetos da Navalria para a Douro Azul, e deverão estar concluídos no início de 2014.</p>
              </div>
			</div>
					...
					<ul class="styled-list style-5">
					 <br> <li>PROJETO: CMT Engineering Ldt. <br>
					   Ship Design</li><br>
                        ...
                        <li>CALADO MIN.: 1,60 m</li><br><li>CALADO AÉREO (a 1,5 m de calado): <br>
                      7,20 m</li><br>
                        <li>CAPACIDADE: Passageiros - 53 cabines  Tripulação - 15 cabines</li><br>
					</ul>
				</div>
			</div>	
