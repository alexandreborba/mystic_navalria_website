...
<html>
 	<head>
		<title>Navalria | Cale de Aveiro</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE REPARAÇÃO <span class="sub-title">/ CALE DE AVEIRO</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_Almadense"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_AreiaMar"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/CaleAveiro/01.jpg" alt="Cale de Aveiro" >
					</div>
				</div></div>
                ...
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/CaleAveiro/02.jpg" alt="Cale de Aveiro" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/CaleAveiro/03.jpg" alt="Cale de Aveiro" ></div></div></td>
                        </tr>
                        </table>
					</div>
				...
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/CaleAveiro/04.jpg" alt="Cale de Aveiro" >
					</div>
				</div></div>
                ...
                <div class="blog-item m-bot-25">
						...
						<table width="100%" cellpadding="0px" cellspacing="0px" >
                       <tr> <td align="left" width="306px"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/CaleAveiro/06.jpg" alt="Cale de Aveiro" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first">&nbsp;</div></div></td>
                        </tr>
                        </table>
					</div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>A manutenção completa do Cale de Aveiro é da responsabilidade da Navalria, que efetua todos os trabalhos de revisão e certificação. Trata-se de um<em> ferry-boat</em>, propriedade da MOVE Ria, que efetua a travessia da ria de Aveiro entre o Forte da Barra e São Jacinto.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>COMPRIMENTO: 34 m</li>
					 <br>
						<li>BOCA: 10 m</li>
						<br>
						<li>CALADO: 3,5 m</li>
						<br>
						<li>DESLOCAMENTO: 300 t</li>
						<br>
