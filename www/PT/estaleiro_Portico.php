		  ...
		  <div class="container clearfix">
				<div class="sixteen columns ">
						<div id="logo-container">	
							...
							<li><a id="flickr-link" title="Português" href="estaleiro_Portico"></a></li>
							<li><a id="vimeo-link" title="English" href="../EN/shipyard_GantryCrane"></a></li>
							<li><a id="rss-link" title="Français" href="../FR/LeChantier_PortiqueRoulant"></a></li>
						</ul>
				</div>
			</div>
			<div class="container clearfix">
       ...
       <div class="in-sixteen in-columns"><p><h1>O Estaleiro</h1></p>
				...
				<div class="row">
					...
					<div class="in-one-third in-column">
						<P><h4>Pórtico rolante</h4></P>
						<p>
                            <strong>CAPACIDADE:</strong> 80 t<br/>
                            <strong>DIMENSÕES:</strong> Altura - 15 m; Largura - 50 m<br/>
                            <strong>PRINCIPAIS VANTAGENS:</strong> Instalado em 2013, o pórtico rolante permitiu à Navalria uma maior flexibilidade na movimentação de peças, otimizando os trabalhos de construção naval.
					</p>
                    <p>&nbsp;<br/><a href="estaleiro">&lt; voltar</a></p></div>
