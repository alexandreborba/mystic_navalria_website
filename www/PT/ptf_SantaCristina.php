...
<html>
 	<head>
		<title>Navalria | Santa Cristina</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE REPARAÇÃO <span class="sub-title">/ SANTA CRISTINA</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_Annerdiep"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_SaoTelmo"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/SantaCristina/01.jpg" alt="Santa Cristina" >
					</div>
				</div></div>
                ...
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/SantaCristina/02.jpg" alt="Santa Cristina" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/SantaCristina/03.jpg" alt="Santa Cristina" ></div></div></td>
                        </tr>
                        </table>
			</div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>A Navalria tem sido um parceiro de confiança na indústria bacalhoeira. Um dos exemplos disso é o bacalhoeiro Santa Cristina, que é reparado nas instalações da empresa desde 1990.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>COMPRIMENTO: 89 m</li>
					 <br>
						<li>BOCA: 14 m</li>
						<br>
						<li>CALADO: 5,5 m</li>
						<br>
						<li>DESLOCAMENTO: 1 600 t</li>
						<br>
					</ul>
				</div>
			</div>	
