...
<html>
 	<head>
		<title>Navalria | Almadense</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE CONSTRUÇÃO <span class="sub-title">/ RESTAURANTE FLUTUANTE</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_Lisbonense"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_CaleAveiro"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/RestauranteFlutuante/10.jpg" alt="Restaurante Flutuante" >
					</div>
				</div></div>
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/RestauranteFlutuante/01.jpg" alt="Restaurante Flutuante" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/RestauranteFlutuante/05.jpg" alt="Almadense" ></div></div></td>
                        </tr>
                        </table>
				</div>
				...
				<div class="content-container-white">
				  <div class="view view-first">
				    <div class="view view-first"> <img src="images/portfolio/RestauranteFlutuante/07.jpg" alt="Douro Spirit" > </div>
				  </div>
		  </div></div>
				...
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/RestauranteFlutuante/08.jpg" alt="Douro Spirit" >
					</div>
				</div></div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p> Trata-se de um restaurante flutuante para o Canal das Pirâmides, no Rossio, em Aveiro.
Uma embarcação diferente e que dará nas vistas num dos canais principais da cidade.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br>
					 <li>COMPRIMENTO: 25,00 m</li><br>
						<li>BOCA: 5,00 m</li><br>
                        <li>CALADO: 0,75 m</li>
                        <br>
                        <li>VELOCIDADE DE CRUZEIRO: <br>
                      Sem propulsão</li>
                        <br>
					</ul>
				</div>
