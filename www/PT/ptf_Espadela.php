	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE CONSTRUÇÃO <span class="sub-title">/ RABELO ESPADELA</span></h1>
	...
	<div class="container clearfix">
        ...
        <div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Espadela_1_Jul2020.jpg" alt=""/></div>
				</div></div>
         ...
         <div class="blog-item m-bot-25">
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white"></div></div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>A embarcação faz parte do contrato de construção de dois rabelos para a empresa Tomaz do Douro.</p>
</div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br><br>
						<li>COMPRIMENTO: 27,80 m</li><br>
                        <li>CAPACIDADE: Passageiros -138 (sentados/as)</li><br>
					</ul>
				</div>
			</div>	
