...
<html>
 	<head>
		<title>Navalria | Contactos</title>
		<meta charset=utf-8 >
	...
	<div class="container clearfix">
		<div class="twelve columns  m-bot-25">
			<div class="content-container-white">
				<!-- Google Maps FIXED HTTPS -->
				<section class="google-map-container">
					<iframe width="698" height="420" frameborder="0" scrolling="no"
					src="https://maps.google.com/maps?f=q&source=s_q&hl=pt-PT&geocode=&q=Navalria-docas,constru%C3%A7%C3%B5es+E+Repara%C3%A7%C3%B5es+Navais+Sa,+Aveiro,+Portugal&aq=0&oq=NAVALRIA&sll=40.635613,-8.682847&sspn=0.005227,0.013078&t=m&g=40.635776,-8.681754&ie=UTF8&hq=Navalria-docas,constru%C3%A7%C3%B5es+E+Repara%C3%A7%C3%B5es+Navais&hnear=S%C3%A1,+Portugal&cid=17646653893351964618&ll=40.635743,-8.679156&spn=0.013678,0.029912&z=15&output=embed">
					</iframe>
				</section>
				<!-- Google Maps / End -->
...
<!-- SIDEBAR -->
		<div class="four columns  m-bot-25">
			<div class="content-container-white">
				<h3 class="title-widget"><span class="bold">COMO </span>CHEGAR</h3>
			</div>
			<div class="under-box-bg"></div>
			<div class="content-container-white padding-cont-15">
				<p><strong>COORDENADAS GPS: </strong>40°38'6.55&quot;N | 8°41'1.57&rdquo;O</p>
<p>  A25 - Saída 3 - Aveiro<br>
  Cais Comercial<br>
  Terminal Sul<br>
