...
<html>
 	<head>
		<title>Navalria | Lisbonense</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFÓLIO DE CONSTRUÇÃO <span class="sub-title">/ LISBONENSE</span></h1>
				<ul class="portfolio-pagination">
					<li>
						<a class="pag-prev" href="ptf_Noruega"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_Almadense"></a>
					</li>
				</ul>
			</div>	
		</div>
...
<!-- CONTENT -->
	<div class="container clearfix">
        ...
        <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/Ferries/02.jpg" alt="Lisbonense" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/Ferries/06.jpg" alt="Lisbonense" ></div></div></td>
                        </tr>
                        </table>
			</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Ferries/09.jpg" alt="Lisbonense" >
					</div>
				</div></div>
...
<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/Ferries/10.jpg" alt="Lisbonense" >
					</div>
				</div></div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Foi a primeira embarcação a ser construída pela Navalria, em 2009. Trata-se de um ferry catamaran que, a par do Almadense, foi construído para a Transtejo.</p>
              </div>
			</div>
