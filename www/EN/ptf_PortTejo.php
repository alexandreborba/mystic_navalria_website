	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">REPAIR PORTFOLIO <span class="sub-title">/ PORT TEJO</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Port Tejo is a bulk ship, owned by Portline. This ship is repaired in Navalria since 1995.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LENGTH: 104 m</li><br>
                        <li>BREADTH: 16.5 m</li><br>
                        <li>DRAUGHT: 6 m</li><br>
                        <li>DISPLACEMENT: 1,700 t</li><br>
					</ul>
				</div>
			</div>	
