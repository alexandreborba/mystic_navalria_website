	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">REPAIR PORTFOLIO <span class="sub-title">/ CALE DE AVEIRO</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Navalria is responsible for the complete maintenance of Cale de Aveiro, executing all scheduled maintenance and certification. It is a ferry boat, owned by MOVE Ria, that crosses the Ria de Aveiro between Barra's Fort and São Jacinto.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LENGTH: 34 m</li><br>
<li>BREADTH: 10 m</li><br>
<li>DRAUGHT: 3.5 m</li><br>
<li>DISPLACEMENT: 300 t
</li><br>
