...
<div class="row">
				<!-- Typography -->
					...
					<div class="in-two-third in-column">
						...
						<p> The construction area develops a different project - a floating restaurant for Ria de Aveiro. In the repair section,the historical Ship-Museum Santo André made maintenance and painting works at the shipyard.</p>
					</div>
				</div>
                              <div class="row">
					<div class="in-one-third in-column">
					...
					<div class="in-two-third in-column">
						...
						<p> In 2014, repairs Delphine, with 93 years is one of the most beautiful luxury yachts in the world history. Built for the Ford family, served the United States Navy for meetings, during the Second World War.
				...
				<div class="row">
					...
					<div class="in-two-third in-column">
						...
						<p>The Amavida and Queen Isabel ships are delivered in February, and baptized in March. The actresses Sharon Stone and Andie MacDowell are the godmothers of AmaVida and Queen Isabel, respectively.</p>
					</div>
				</div>
				<div class="row">
					 <div class="in-one-third in-column">
					...
					<div class="in-two-third in-column">
						...
						<p>After the conclusion of Douro Spirit, in March, Douro Azul orders two more ships to Navalria, Queen Isabel and Amavida. In the last quarter of the year, the cruise ship operator orders another two ships, Vinking Hemming and Viking Torgil, which will be concluded by 2014.</p>
					</div>
               ...
               <div class="row">
					...
					<div class="in-two-third in-column">
						...
						<p>The company wins its first project to build an hotel ship for Douro Azul – Douro Spirit – an innovative, energy efficient and with an attractive design, a strong investment in luxury, built in less than a year.</p>
					</div>
				</div> 
                <div class="row">
					<div class="in-one-third in-column">
					...
					<div class="in-two-third in-column">
						...
						<p>Martifer acquired the totality of Navalria's share capital, following its diversification strategy tto activities related to steel construction.<br/>
Navalria won, in a public tender, its first shipbuilding project: two ferries for Transtejo (Lisbonense and Almadense).<br/>
It started a modernization process in the shipyard, whichincluded the recovery and requalification of pre-existent infrastructures, construction of an industrial unit and acquisition of equipment.</p>
					</div>
				</div> 
                <div class="row">
					<div class="in-one-third in-column">
					...
					<div class="in-two-third in-column">
						<p><h3 class="title-block">The 90's</h3></p>
						<p>With the consecutive divestments in the sea and fisheries areas, the shipbuilding activity had been decreasing. The company surpassed this period by dedicating solely to ship repair.</p>
					</div>
				</div> 
                <div class="row">
					<div class="in-one-third in-column">
					...
					<div class="in-two-third in-column">
						<p><h3 class="title-block">The 80's</h3></p>
						<p>Taking advantage of the great expansion of the fishing industry in the country, which led to investments in the fleet renovation by the fishing companies, Navalria associated with the São Jacinto shipyard, obtaining a greater capacity to build steel ships.</p>
					</div>
				</div> 
                 <div class="row">
					<div class="in-one-third in-column">
					...
					<div class="in-two-third in-column">
						...
						<p>Foundation of Navalria, a shipyard focused on ship repair. Located in Aveiro, Navalria answered the needs to repair and maintain the fishing ships in the region, namely cod-fishing.</p>
					</div>
				</div> 
			</div>		
		</div>
	...
	<!--<div class="container clearfix">
		<div class="eight columns m-bot-25">-->
				<!-- TABS -->
						...
						<!--<div class="tab-caption-container m-bot-20">
							<div class="caption-main-container clearfix">
								<div class="caption-text-container">
									<span class="bold">OUR</span> SERVICES
								</div>
							</div>
						</div>
						...
						<div class="content-container-white">
							<div id="tab1" class="tab-content" >
								<ul class="tab-post-container text">
									<li>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nisl orci, condim entum ultrices consequat eu, vehicula. Aenean nisl orci.</p>
										<p>Aenean nisl orci, condim entum ultrices consequat eu, vehicula ac. Lorem ipsum dolor sit amet.</p>
									</li>
							...
							<div id="tab3" class="tab-content" >
								<ul class="tab-post-container text">
									<li>
										<p>Ut adipiscing, leo nec. Lorem ipsum dolor sit amet, consectetur adipiscing elit.  Ut adipiscing, leo nec. Aenean nisl orci.</p>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nisl orci, condim entum ultrices consequat eu, vehicula.</p>
									</li>
								</ul>
							</div>
...
<!--	<div class="eight columns">
			<div class="testimonials-caption-container m-bot-20">
				<div class="caption-main-container clearfix">
					<div class="caption-text-container">
		...
		<!-- jCAROUSEL -->
		<!--<div class="jcarousel testimonials-jc m-bot-25" >
			<ul>-->
				<!-- TESTIMONIALS ITEM -->
				<!--<li class="eight columns alpha">
						<div class="testimonial-quote">
							<div class="quote-content t1">
							...
							<div class="quote-author">
								<div class="author-testimonial">John Doe</div>
	...
	<!--<div class="container clearfix">
		<div class="sixteen columns m-bot-20">
			<div class="our-clients-caption-container">
				<div class="caption-main-container clearfix">
					<div class="caption-text-container">
						<span class="bold">OUR</span> CLIENTS
					</div>
				</div>
			</div>
		</div>
