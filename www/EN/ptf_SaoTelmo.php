	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">REPAIR PORTFOLIO <span class="sub-title">/ SÃO TELMO</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Navalria has also experience in repairing tourist boats, such as São Telmo, a Rabelo boat, owned by Via Douro, which was enlarged at Navalria.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LENGTH: 37 m</li><br>
                        <li>BREADTH: 5.6 m</li><br>
                        <li>DRAUGHT: 1.6 m</li><br>
                        <li>DISPLACEMENT: 60 t</li><br>
					</ul>
				</div>
			</div>	
