	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">SHIPBUILDING PORTFOLIO <span class="sub-title">/ QUEEN ISABEL</span></h1>
...
<!-- SIDEBAR -->
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				<div class="content-container-white">
					<h3 class="title-widget"><span class="bold">PROJECT</span> OVERVIEW</h3>
				</div>
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Queen Isabel was one of the two ships built to Douro Azul during 2012. It has an heated pool, located in the sundeck, gymnasium, therapy massages, spa, and other facilities.</p>
						<p>The ship is supplied by 155 sqm of solar photovoltaic panels and the engines are energy efficient.</p>
              </div>
			</div>
		...
		<!-- WIDGET -->
			<div class="sidebar-item  m-bot-25">
				<div class="content-container-white">
					<h3 class="title-widget"><span class="bold">PROJECT</span> DETAILS</h3>
				</div>
				<div class="under-box-bg"></div>
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>PROJETO: CMT Engineering Ldt. <br>
					   Ship Design</li><br>
						<li>LENGTH OVERALL EXTREME: 79.85 m</li><br>
						<li>LENGTH BP: 72.90 m</li><br>
						<li>BREADTH MLD: 11.00 m</li><br>
                        <li>BREADTH EXT.: 11.40 m</li><br>
                        <li>DEPTH : 3.20 m</li><br>
                        <li>DRAUGHT MAX. : 1.80 m</li><br>
                        <li>AIR DRAFT (at 1.5 m draught): 7.20 m</li><br>
                        <li>CAPACITY: Passengers: 59 cabins; <BR>Crew - 13 cabins</li><br>
					</ul>
				</div>
			</div>	
