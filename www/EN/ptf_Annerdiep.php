	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">REPAIR PORTFOLIO <span class="sub-title">/ ANNERDIEP</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Since 2003 the company Intership Navegation.co executes the repairing of the cargo ship Annerdiep in Navalria's facilities.</p>
              </div>
			</div>
...
<li>DRAUGHT: 6 m</li><br>
<li>DISPLACEMENT: 1,200 t</li><br>
