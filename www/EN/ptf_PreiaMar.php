	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">REPAIR PORTFOLIO <span class="sub-title">/ PREIA-MAR</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Preia-Mar is a, Inspection Launch Boat, owned by Marinha Portuguesa (Portuguese Navy), which scheduled maintenance and certification works are also provided by Navalria.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LENGTH: 14 m</li><br>
<li>BREADTH: 3.5 m</li><br>
<li>DRAUGHT: 1.2 m</li><br>
<li>DISPLACEMENT: 25 t</li><br>
					</ul>
				</div>
			</div>	
