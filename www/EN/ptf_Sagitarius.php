	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">REPAIR PORTFOLIO <span class="sub-title">/ SAGITTARIUS</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Over the last eight years, the fishing vessel Sagittarius, owned by Testas e Cunhas, Lda, has been totally repaired in Navalria's Shipyard.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LENGTH: 28 m</li><br>
                        <li>BREADTH: 7.5 m</li><br>
                        <li>DRAUGHT: 4.6 m</li><br>
                        <li>DISPLACEMENT: 330 t</li><br>
</li><br>
					</ul>
				</div>
			</div>	
