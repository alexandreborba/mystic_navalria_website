	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">REPAIR PORTFOLIO <span class="sub-title">/ SANTA CRISTINA</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Navalria has been a trusting partner in the cod fishing industry. One example of that is the cod fishing ship Santa Cristina, which is repaired in the company's facilities since 1990.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LENGTH: 89 m</li><br>
<li>BREADTH: 14 m</li><br>
<li>DRAUGHT: 5.5 m</li><br>
<li>DISPLACEMENT: 1,600 t</li><br>
					</ul>
				</div>
			</div>	
