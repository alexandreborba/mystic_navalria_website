	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">SHIPBUILDING PORTFOLIO <span class="sub-title">/ AMAVIDA</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Amavida was one of the two ships built to Douro Azul during 2012. It has an heated pool, located in the sundeck, gymnasium, therapy massages, spa, and other facilities.</p>
					...
					<ul class="styled-list style-5">
					 <br> <li>PROJECT: CMT Engineering Ldt. <br>
					   Ship Design</li><br>
                        ...
                        <li>CAPACITY: Passengers: 54 cabins<BR>Crew - 13 cabins</li><br>
					</ul>
				</div>
			</div>	
