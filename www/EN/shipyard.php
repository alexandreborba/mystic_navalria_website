...
<html>
 	<head>
		<title>Navalria | The Shipyard</title>
		<meta charset=utf-8 >
...
<!-- CONTENT -->
	<div class="container m-bot-25 clearfix">
       ...
       <div class="row"> 
       <div class="in-sixteen in-columns"><p><h1>The Shipyard</h1></p>
       </div>
       </div>
				...
				<div class="row">
					...
					<div class="in-one-third in-column">
						<P>Located in the Porto f Aveiro, Navalria's shipyard was renovated in 2008 and has several equipments that allow it to build and repair several ships at the same time, therefore complementing the Metallic construction activity of the Martifer Group, giving it further flexibility and range to other products and services.<br/>&nbsp;
                        </P>
                        
                                                <p>
                        <strong>TOTAL AREA: </strong>12.5 ha<br/>
                        <strong>COVERED AREA: </strong>0.642 ha<br/>
                      <strong>FAIRWAY:</strong> up to 7 m<br/>&nbsp;</p>
                        <p>
                        <font color="#f1592a"><strong> A | </strong></font><a href="shipyard_DryDoc">Dry dock</a><br/>
                        <font color="#f1592a"><strong> B | </strong></font><a href="shipyard_GantryCrane">Gantry Crane</a><br/>
                        <font color="#f1592a"><strong> C | </strong></font><a href="shipyard_FloatingDock">Floating dock</a><br/>
                        <font color="#f1592a"><strong> D | </strong></font><a href="shipyard_Shiplift">Shiplift</a><br/>
                        <font color="#f1592a"><strong> E | </strong></font><a href="shipyard_otherEquipment">Units Assembly shop</a><br/>
                        <font color="#f1592a"><strong> F | </strong></font><a href="shipyard_otherEquipment">Mechanics Shop</a><br/>
                        <font color="#f1592a"><strong> G | </strong></font><a href="shipyard_otherEquipment">Carpentry</a><br/>
                        <font color="#f1592a"><strong> H | </strong></font><a href="shipyard_otherEquipment">Steel plate storage</a><br/>
                        <font color="#f1592a"><strong> I | </strong></font><a href="shipyard_otherEquipment">Units Assembly Berths</a><br/>
                        <font color="#f1592a"><strong> J | </strong></font><a href="shipyard_otherEquipment">Warehouses</a><br/>
					</p></div>
					
					<div class="in-two-third in-column">
						<p><img src="images/estaleiro.jpg"/></p>
					</div>
				</div>
