       ...
       <div class="in-sixteen in-columns"><p><h1>The Shipyard</h1></p>
				...
				<div class="row">
					...
					<div class="in-one-third in-column">
						<P><h4>Floating Dock</h4>
						</P>
					  <p>
                            <strong>LENGTH: </strong>60 m<br/>
                            <strong>BREADTH:</strong> 12 m<br/>
                            <strong>DRAUGHT:</strong> 4.2 m<br/>
                            <strong>CARRYING CAPACITY:</strong> 800 t
					...
					<div class="in-two-third in-column">
						<p><img src="images/DocaFlutuante.jpg"/></p>
					</div>
				</div>
