	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">REPAIR PORTFOLIO <span class="sub-title">/ RIA DE VIGO</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Ria de Vigo, a deep sea towage owned by Remolcanosa, has been repaired in Navalria for more than 5 years.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LENGTH: 90 m</li><br>
<li>BREADTH: 14 m</li><br>
<li>DRAUGHT: 7 m
</li><br>
					</ul>
				</div>
