...
<div class="row">
				...
				<div class="row">
					...
					<div class="in-two-third in-column">
						...
						<p>Recyship is an ambitious European project framed within the LIFE+ program in the action line of "Environment Policy and Governance" to be developed during the period 2009-2012. The intention is to address the issue of ship scrapping in matters of occupational safety, health and environmental protection.</p>
<p>
This project seeks to support the European Commission in developing rules and guidelines in relation to vessels that, for various reasons, must be removed becoming a unique residue very complex to manage.</p>
<p>Learn more at <a href="http://www.recyship.com/" target="_blank">www.recyship.com</a></p>
					</div>
				</div>
					...
					<div class="in-two-third in-column">
						<h3 class="title-block">Portuguese Naval Industries Association</h3>
					  <p>The Naval industries Association is an employers non-profit association, which main objectives are:</p>
					  <p><strong>a) </strong>To protect the rights and interests of all its associates and contribute for their dignity and prestige;<br>
					    <strong>b)</strong> To coordinate and support initiatives of the associates in every matter that complies with the associative purposes;<br>
					    <strong>c)</strong> To contribute to the development of the associates' activities in particular and, consequently, to the Portuguese economy, aiming the establishment of a climate of development and a fair social harmony;<br>
				      <strong>d)</strong> To develop a spirit of solidarity and mutual support among its members. </p>
<p>Learn more at <a href="http://www.ain.pt/" target="_blank">www.ain.pt</a></p>
					</div>
				</div>
