	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">REPAIR PORTFOLIO <span class="sub-title">/ AREIA MAR</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Areia Mar is a hopper dredger, owned by Manuel Maria Almeida e Silva. This boat has been repaired in Navalria for 12 years.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LENGTH: 68 m</li><br>
                        <li>BREADTH: 12 m</li><br>
                        <li>DRAUGHT: 5 m</li><br>
                        <li>DISPLACEMENT: 700 t</li><br>
