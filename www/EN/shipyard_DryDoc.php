       ...
       <div class="in-sixteen in-columns"><p><h1>The Shipyard</h1></p>
				...
				<div class="row">
					...
					<div class="in-one-third in-column">
						<P><h4>Dry Dock</h4></P>
						<p>
                            <strong>LENGTH:</strong> 104 m<br/>
                            <strong>BREADTH:</strong> 18 m<br/>
                            <strong>DRAUGHT:</strong> 6.5 m<br/>
                            <strong>CARRYING CAPACITY:</strong> 3,500 t
					...
					<div class="in-two-third in-column">
						<p><img src="images/DocaSeca.jpg"/></p>
					</div>
				</div>
