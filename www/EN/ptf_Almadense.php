	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">SHIPBUILDING PORTFOLIO <span class="sub-title">/ ALMADENSE</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>It was the second ship built by Navalria, in 2009. It is a catamaran ferry that, together with Lisbonense, was built for Transtejo.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>PROJECT: OCE Engineering</li><br>
<li>LENGTH: 47.50 m</li><br>
<li>BREADTH: 16.00 m</li><br>
<li>DEPTH: 3.65 m</li><br>
<li>DRAUGHT: 2.20 m</li><br>
                        <li>CAPACITY: 360 seated places <br>and 29 vehicles</li><br>
					</ul>
				</div>
			</div>	
