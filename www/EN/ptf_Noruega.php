	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">REPAIR PORTFOLIO <span class="sub-title">/ NORUEGA</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>For 10 years, Navalria executes the maintenance of this fisheries research ship, owned by the Portuguese Fisheries Research Institute (Instituto Português de Investigação em Pescas).</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LENGTH: 50 m</li>
					 <br>
						<li>BREADTH: 10 m</li>
						<br>
						<li>DRAUGHT: 6.5 m</li>
						<br>
						<li>DISPLACEMENT: 600 t</li>
						<br>
					</ul>
				</div>
			</div>	
