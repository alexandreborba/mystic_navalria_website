...
<!-- HEADER -->
		<span class="page-title">REPAIR </span>
		<header id="header">
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTFOLIO <span class="sub-title">/ PROMETEU</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>During the last 15 years, the tugboat Prometeu, owned by the Port of Leixões Administration, has been totally repaired in Navalria Shipyard.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LENGTH: 30 m</li><br>
						<li>BREADTH: 8 m</li>
						<br>
						<li>DRAUGHT: 6 m</li>
						<br>
						<li>DISPLACEMENT: 350 t</li>
						<br>
