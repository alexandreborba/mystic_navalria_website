	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">SHIPBUILDING PORTFOLIO <span class="sub-title">/ FLOATING RESTAURANT</span></h1>
		...
		<!-- PORTFOLIO ITEM -->
			<div class="blog-item m-bot-25">
                ...
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="../PT/images/portfolio/RestauranteFlutuante/01.jpg" alt="Almadense" ></div></div></td>
                        <td width="25px">&nbsp;</td>
				...
				<div class="content-container-white">
					<div class="view view-first">
						<img src="../PT/images/portfolio/RestauranteFlutuante/07.jpg">
					</div>
				</div></div>
				...
				<div class="content-container-white">
					<div class="view view-first">
						<img src="../PT/images/portfolio/RestauranteFlutuante/08.jpg">
					</div>
				</div></div>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>A floating restaurant for Canal das Pirâmides, in Rossio, Aveiro. A different construction project that will attract the attention in one of the main canals of the city center.</p>
			  </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br>
					 <li>LENGTH: 25,00 m</li><br>
<li>BREADTH:  5,00 m</li><br>
<li>DRAUGHT:  0,75 m</li><br>
                        <li>CRUISE SPEED: No propulsion</li>
                        <br>
					</ul>
				</div>
			</div>	
