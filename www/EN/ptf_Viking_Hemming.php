	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">ONGOING PORTFOLIO <span class="sub-title">/ VIKING HEMMING</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Viking Hemming is, with Viking Torgil, one of the two  latest Navalria projects for Douro Azul, and should be concluded by 2014.</p>
              </div>
			</div>
					...
					<ul class="styled-list style-5">
					 <br> <li>PROJECT: CMT Engineering Ldt.<br>
					   Ship Design</li><br>
                        ...
                        <li>DRAUGHT MIN. : 1.60 m</li><br>
                        <li>AIR DRAFT (at 1.5 m draught): 7.20 m</li><br>
                        <li>CAPACITY: Passengers - 53 cabins;<br> Crew - 15 cabins</li><br>
					</ul>
				</div>
			</div>	
