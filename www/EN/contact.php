...
<html>
 	<head>
		<title>Navalria | Contact us</title>
		<meta charset=utf-8 >
			...
			<div class="content-container-white">
				<!-- Google Maps -->
					<section class="google-map-container">
						...
						<iframe width="698" height="420" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=pt-PT&amp;geocode=&amp;q=Navalria-docas,constru%C3%A7%C3%B5es+E+Repara%C3%A7%C3%B5es+Navais+Sa,+Aveiro,+Portugal&amp;aq=0&amp;oq=NAVALRIA&amp;sll=40.635613,-8.682847&amp;sspn=0.005227,0.013078&amp;t=m&amp;g=40.635776,-8.681754&amp;ie=UTF8&amp;hq=Navalria-docas,constru%C3%A7%C3%B5es+E+Repara%C3%A7%C3%B5es+Navais&amp;hnear=S%C3%A1,+Portugal&amp;cid=17646653893351964618&amp;ll=40.635743,-8.679156&amp;spn=0.013678,0.029912&amp;z=15&amp;output=embed"></iframe><br />
					</section>
				<!-- Google Maps / End -->
...
<!-- SIDEBAR -->
		<div class="four columns  m-bot-25">
			<div class="content-container-white">
				<h3 class="title-widget"><span class="bold">DRIVING </span>DIRECTIONS</h3>
			</div>
			<div class="under-box-bg"></div>
			<div class="content-container-white padding-cont-15">
				<p><strong>GPS COORDINATES: </strong>40°38'6.55&quot;N | 8°41'1.57&rdquo;O</p>
<p>  A25 - Exit 3 - Aveiro<br>
  Cais Comercial (Commercial Pier)<br>
  Terminal Sul (South Terminal)<br>
  <strong>NAVALRIA </strong></p>
		  </div>
			<div class="under-box-bg"></div>
			<div class="content-container-white">
				<ul class="contact-info-page">
					<li class="icon_loc">Apartado 39<br/>
                    Porto Comercial <br>
                    Terminal Sul<br/>
                    3811-901 Aveiro</li>
					<li class="icon_phone">(+351) 234 378 970<br><br></li>
                    <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>FAX:</strong>&nbsp;&nbsp;(+351) 234 378 971</li>
					<li class="icon_mail"><a href="mailto:info@navalria.pt">info@navalria.pt</a></li>
				</ul>	
			</div>		
		</div>
	</div>
