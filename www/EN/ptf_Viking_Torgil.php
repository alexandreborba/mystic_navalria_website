	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">ONGOING PORTFOLIO <span class="sub-title">/ VIKING TORGIL</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Viking Torgil is, with Viking Hemming, one of the two  latest Navalria projects for Douro Azul, and should be concluded by 2014.</p>
              </div>
			</div>
