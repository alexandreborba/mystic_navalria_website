	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">SHIPBUILDING PORTFOLIO <span class="sub-title">/ DOURO SPIRIT</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Built in 2011, Douro Spirit was the first hotel ship built by Navalria to Douro Azul.</p>
						<p>It is an innovative ship, and has an economic engine, which allows it to reduce the ship's CO<sub>2</sub> emissions, LED lighting and also pre-heating of bathing water via heat exchanger, using the engine's cooling water.</p>
</div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>PROJECT: CMT Engineering Ldt. <br>
					   Ship Design</li><br>
						<li>LENGTH OVERALL EXTREME: 79.50 m</li><br>
						<li>LENGTH BP: 72.90 m</li><br>
						<li>BREADTH MLD: 11.00 m</li><br>
                        <li>BREADTH EXT.: 11.40 m</li><br>
                        <li>DEPTH MLD: 3.30 m</li><br>
                        <li>DRAUGHT MAX. (Design slwl): 1.80 m</li><br>
                        <li>DRAUGHT MIN. (Operational): 1.60 m</li><br>
                        <li>CAPACITY: Passengers - 65 cabins;<BR>Crew - 12 cabins</li><br>
					</ul>
				</div>
			</div>	
