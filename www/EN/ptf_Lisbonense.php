	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">SHIPBUILDING PORTFOLIO <span class="sub-title">/ LISBONENSE</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>It was the first ship built by Navalria, in 2009. It is a catamaran ferry that, together with Almadense, was built for Transtejo.</p>
              </div>
			</div>
...
<li>CAPACITY: 360 seated places <br>and 29 vehicles
</li><br>
