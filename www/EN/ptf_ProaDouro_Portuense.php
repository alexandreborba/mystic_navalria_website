...
<html>
 	<head>
		<title>Navalria | Proa Douro and Portuense</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">SHIPBUILDING PORTFOLIO <span class="sub-title">/ PROA DOURO AND PORTUENSE</span></h1>
	...
	<div class="container clearfix">
		...
		<!-- PORTFOLIO ITEM -->
			<div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/ProaDeP/01.jpg" alt="Proa Douro and Portuense" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="images/portfolio/ProaDeP/02.jpg" alt="Proa Douro and Portuense" ></div></div></td>
                        </tr>
                        </table>
			</div>
            ...
            <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/ProaDeP/rabelos_1.jpg" alt="Proa Douro and Portuense" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right">&nbsp;</td>
                        </tr>
                        </table>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Built for Via Douro, these two boats, unlike traditional Rabelo boats, are built in steel. This construction ensures the complying with fireproof requirements and makes its repair cheaper and faster.</p>
						<p>On the other hand, steel constructions makes the boats lighter and, therefore, more ecological, by reducing fuel consumption.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>PROJECT: CNV Naval Architects</li><br>
						<li>LENGTH OVERALL EXTREME: 19.00 m</li><br>
						<li>LENGTH BP: 15.00 m</li><br>
						<li>BREADTH EXT.: 4.00 m </li><br>
                        <li>DRAUGHT MAX. (Design slwl): 0.60 m</li>
                        <br>
                        <li>CAPACITY: 45 px</li><br>
					</ul>
				</div>
			</div>	
