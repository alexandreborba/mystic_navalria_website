	...
	<div class="container m-bot-25 clearfix">
       ...
       <div class="in-sixteen in-columns"><p><h1>The Shipyard</h1></p>
				...
				<div class="in-one-third in-column">
						<P><h4>Gantry Crane </h4></P>
						<p>
                            <strong>CAPACITY:</strong> 80 t<br/>
                            <strong>SIZE:</strong> Height - 15 m; Width - 50 m<br/>
                            <strong>MAIN ADVANTAGES:</strong> Installed in 2013, the gantry crane allowed to Navalria a greater flexibility in the blocks transportation, optimizing the shipbuilding works.
					</p>
                    <p>&nbsp;<br/><a href="shipyard">&lt; back</a></p></div>
					
					<div class="in-two-third in-column">
						<p><img src="images/Portico.jpg"/></p>
					</div>
				</div>
