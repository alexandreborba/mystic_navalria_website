...
<html>
 	<head>
		<title>Navalria | Who we are</title>
		<meta charset=utf-8 >
...
<div class="row">
				...
				<div class="row">
					<div class="in-sixteen in-columns">
                        ...
                        <p>
							Navalria is a shipyard that develops activity in ship building and repair. With over 35 years in activity, the company has surpassed several stages of significant changes in the markets, being able to survive several difficulties and adversities of the environment, namely in its activity sector, the naval industry.</p>
							<p>Therefore, the company took the place as <strong>a strategic unit for its region </strong>– Aveiro – by maintaining the recognition of its clients.</p>
							<p>Navalria has been changing its management paradigms, following key priorities, for the maintenance of any organization:</p>
							<ul class="styled-list style-4">
							  <li>The investment in people – only with motivated employees it is possible to achieve high levels of productivity and value creation</li>
                              <li>The quality of the services provided to the client</li>
					  </ul>
							<p>After many years operating exclusively in the ship repair activity, since 2009, Navalria started and has been complementing this activity with the construction of ships in steel. Currently, it has a few emblematic constructions in its portfolio and is one of the main shipyards in Portugal. Navalria is also the only Portuguese Shipyard that is part of the European list of licensed shipyards for the dismantling and recycling of out-of-service vessels.</p>
<p><strong>The demonstrated capacity in every project has contributed for the trust of our clients</strong> and to ensure the maintenance and expansion of the shipbuilding business.</p>
					</div>
				...
				<div class="row">
					...
					<div class="in-two-third in-column">
						<p>With 80 workers, Navalria's investment in the people and their personal and professional development has allowed for the company to improve significantly its performance, with the strength and confidence necessary to operate in a sector full of challenges.</p>
					<p><strong>It is based on this team that Navalria faces the future with optimism and confidence.</strong></p>
					</div>
