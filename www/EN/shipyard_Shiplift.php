       ...
       <div class="in-sixteen in-columns"><p><h1>The Shipyard</h1></p>
			...
			<div class="row">
					...
					<div class="in-one-third in-column">
					  ...
					  <p><strong>TRANSFERRING:</strong> 24 m and 4 ship stowage spots<br/>
                           <strong> LENGTH:</strong> 36 m<br/>
                            <strong>BREADTH:</strong> 8 m<br/>
                            <strong>DRAUGHT:</strong> 4.6 m<br/>
                            <strong>CARRYING CAPACITY:</strong> 300 t
                  ...
                  <p>&nbsp;<br/><a href="shipyard">&lt; back</a></p>
					...
					<div class="in-two-third in-column">
						<p><img src="images/Elevador.jpg"/></p>
					</div>
				</div>
