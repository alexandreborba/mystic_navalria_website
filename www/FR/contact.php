...
<html>
 	<head>
		<title>Navalria | Contactes</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">CONTACTES</h1>
			</div>	
		</div>
	</div>	
<!-- CONTENT -->
...
<!-- SIDEBAR -->
		<div class="four columns  m-bot-25">
			<div class="content-container-white">
				<h3 class="title-widget"><span class="bold">COMMENT </span>ARRIVER CHEZ NOUS</h3>
			</div>
			<div class="under-box-bg"></div>
			<div class="content-container-white padding-cont-15">
				<p><strong>COORDONNÉES GPS: </strong>40°38'6.55&quot;N | 8°41'1.57&rdquo;O</p>
<p>  A25 - Sortie 3 - Aveiro<br>
  Cais Comercial<br>
  Terminal Sud<br>
