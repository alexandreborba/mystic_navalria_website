	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE CONSTRUCTION<span class="sub-title">/ AMAVIDA</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>L' AmaVida  a été l'un des deux navires construit pour l'entreprise Douro Azul pendant 2012. Il compte avec une piscine chauffé, situe dans le pont solaire, gymnase, massages thérapeutiques, spa, entre autres conforts. </p>
					...
					<ul class="styled-list style-5">
					 <br> <li>PROJET: CMT Engineering Ldt. <br>
					   Ship Design</li><br>
                        ...
                        <li>CAPACITÉ: Passagers - 54 cabines  Équipage - 13 cabines</li><br>
					</ul>
				</div>
			</div>	
