	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE RÉPARATION <span class="sub-title">/ NORUEGA</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Depuis 10 ans que Navalria fait la manutention général de ce navire d'investigation de Pèche, propriété de l'Institut Portugais d'Investigation des Pêches.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LONGUEUR: 50 m</li>
					 <br>
						<li>BOUCHE: 10 m</li>
						<br>
						<li>TIRANT D'EAU: 6,5 m</li>
						<br>
						<li>DÉPLACEMENT: 600 t</li>
						<br>
					</ul>
				</div>
			</div>	
