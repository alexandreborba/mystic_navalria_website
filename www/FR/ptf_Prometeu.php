	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE RÉPARATION <span class="sub-title">/ PROMETEU</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Au cours des 15 dernières années, le navire remorqueur Prometeu, de l'Administration du Port Douro Leixões, a été totalement réparé dans les chantiers de Navalria.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LONGUEUR: 30 m</li><br>
						<li>BOUCHE: 8 m</li>
						<br>
						<li>TIRANT D'EAU: 6 m</li>
						<br>
						<li>DÉPLACEMENT: 350 t</li>
						<br>
