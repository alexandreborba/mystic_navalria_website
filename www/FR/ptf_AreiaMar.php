	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE RÉPARATION <span class="sub-title">/ AREIA MAR</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>L' Areia Mar est une drague de succion, propriété de Manuel Maria Almeida e Silva. Cette embarcation est réparée chez Navalria il y a 12 ans.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LONGUEUR: 68 m</li>
					 <br>
						<li>BOUCHE: 12 m</li>
						<br>
						<li>TIRANT D'EAU: 5 m</li>
						<br>
						<li>DÉPLACEMENT: 700 t</li>
						<br>
