	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE EN COURS <span class="sub-title">/ VIKING HEMMING </span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Viking Hemming, comme le Viking Torgil, est un des deux plus récents projets de Navalria pour l'entreprise Douro Azul, et devront être terminé au début de 2014.</p>
              </div>
			</div>
					...
					<ul class="styled-list style-5">
					 <br> <li>PROJET: CMT Engineering Ldt. <br>
					   Ship Design</li><br>
                        ...
                        <li>TIRANT D'EAU MIN.: 1,60 m</li><br>
                        <li>TIRANT D'EAU AÉRIEN (à 1,5 m de tirant d'eau):<br>
                      7,20 m</li><br>
                        <li>CAPACITÉ: Passagers - 53 cabines  Équipage - 15 cabines</li><br>
					</ul>
				</div>
			</div>	
