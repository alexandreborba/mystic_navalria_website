	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE CONSTRUCTION <span class="sub-title">/ ALMADENSE</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Ça a été la deuxième embarcation construite par Navalria, en 2010. C'est un ferry catamaran qui, comme le Lisbonense, a été construit pour l'entreprise Transtejo.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>PROJET: OCE Engineering</li><br>
						<li>LONGUEUR: 47,50 m</li><br>
						<li>BOUCHE: 16,00 m</li><br>
						<li>PONTAL: 3,65 m</li><br>
                        <li>TIRANT D'EAU: 2,20 m</li><br>
                        <li>CAPACITÉ: <br>
                        360 passagers assis  et 29 véhicules</li><br>
					</ul>
				</div>
			</div>	
