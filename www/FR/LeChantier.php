...
<html>
 	<head>
		<title>Navalria | Le Chantier</title>
		<meta charset=utf-8 >
...
<!-- CONTENT -->
	<div class="container m-bot-25 clearfix">
       ...
       <div class="row"> 
       <div class="in-sixteen in-columns"><p><h1>Le Chantier</h1></p>
       </div>
       </div>
				...
				<div class="row">
					<div class="in-one-third in-column">
						<P>Situé dans le Port de Aveiro, le chantier de Navalria a été renouvelé en 2008 et compte avec les plus divers équipements qui lui permettent de construire et réparer plusieurs navires en simultanéité, complétant ainsi l'activité de la construction métallique du groupe Martifer, en donnant plus de flexibilité et couverture à d'autres produits et services.<br/>&nbsp;
                        </P>
                        
                                                <p>
                        <strong>AIRE TOTAL: </strong>12,5 ha<br/>
                        <strong>AIRE COUVERT: </strong>0,642 ha<br/>
                      <strong>CANAL NAVIGABLE:</strong> jusqu'à 7 m<br/>&nbsp;</p>
                        <p>
                        <font color="#f1592a"><strong> A | </strong></font><a href="LeChantier_CaleSeche">Cale sèche</a><br/>
                        <font color="#f1592a"><strong> B | </strong></font><a href="LeChantier_PortiqueRoulant">Portique roulant</a><br/>
                        <font color="#f1592a"><strong> C | </strong></font><a href="LeChantier_CaleFlottante">Cale flottante</a><br/>
                        <font color="#f1592a"><strong> D | </strong></font><a href="LeChantier_Elevateur">Élévateur des navires</a><br/>
                        <font color="#f1592a"><strong> E | </strong></font><a href="LeChantier_Autres">Atelier d'assemblage des blocs</a><br/>
                        <font color="#f1592a"><strong> F | </strong></font><a href="LeChantier_Autres">Atelier Mécanique</a><br/>
                        <font color="#f1592a"><strong> G | </strong></font><a href="LeChantier_Autres">Charpenterie</a><br/>
                        <font color="#f1592a"><strong> H | </strong></font><a href="LeChantier_Autres">Parc des tôles</a><br/>
                        <font color="#f1592a"><strong> I | </strong></font><a href="LeChantier_Autres">Table d'alignement des blocs</a><br/>
                        <font color="#f1592a"><strong> J | </strong></font><a href="LeChantier_Autres">Entrepôts</a><br/>
					</p></div>
