	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE CONSTRUCTION <span class="sub-title">/ PREIA-MAR</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Le Preia-Mar est une chaloupe de fiscalisation, propriété de la Marine Portugaise, et dont les travaux de révision et certification sont aussi fait par Navalria.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LONGUEUR: 14 m</li>
					 <br>
						<li>BOUCHE: 3,5 m</li>
						<br>
						<li>TIRANT D'EAU:1,2 m</li>
						<br>
						<li>DÉPLACEMENT: 25 t</li>
						<br>
					</ul>
				</div>
			</div>	
