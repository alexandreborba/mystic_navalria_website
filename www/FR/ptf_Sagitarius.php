	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE RÉPARATION <span class="sub-title">/ SAGITTARIUS</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Au long des 8 dernières années, le navire de pêche Sagittarius, propriété de l'entreprise Testas e Cunhas Lda, a été totalement réparé dans les chantiers de Navalria. </p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LONGUEUR: 28 m</li>
					 <br>
						<li>BOUCHE: 7,5 m</li>
						<br>
						<li>TIRANT D'EAU: 4,6 m</li>
						<br>
						<li>DÉPLACEMENT: 330 t</li>
						<br>
					</ul>
				</div>
			</div>	
