	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE RÉPARATION <span class="sub-title">/ CALE DE AVEIRO</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>La manutention complète du Cale de Aveiro est de la responsabilité de Navalria, qui fait tous les travaux de révision et de certification.  C'est un ferry-boat, propriété de MOVE Ria, qui fait la traversée de la Ria de Aveiro entre le Fort de la Barra et São Jacinto.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LONGUEUR: 34 m</li>
					 <br>
						<li>BOUCHE: 10 m</li>
						<br>
						<li>TIRANT D'EAU: 3,5 m</li>
						<br>
						<li>DEPLACEMENT: 300 t</li>
						<br>
