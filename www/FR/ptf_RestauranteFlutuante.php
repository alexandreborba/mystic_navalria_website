	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE CONSTRUCTION <span class="sub-title">/  RESTAURANT FLOTTANT</span></h1>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="../PT/images/portfolio/RestauranteFlutuante/10.jpg" >
					</div>
				</div></div>
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="../PT/images/portfolio/RestauranteFlutuante/05.jpg"></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right"><div class="content-container-white">
					<div class="view view-first"><img src="../PT/images/portfolio/RestauranteFlutuante/01.jpg"></div></div></td>
                        </tr>
                        </table>
				</div>
				...
				<div class="content-container-white">
					<div class="view view-first">
						<img src="../PT/images/portfolio/RestauranteFlutuante/07.jpg" alt="Douro Spirit" >
					</div>
				</div></div>
				...
				<div class="content-container-white">
					<div class="view view-first">
						<img src= "../PT/images/portfolio/RestauranteFlutuante/08.jpg" alt="Douro Spirit" >
					</div>
				</div></div>
...
<!-- SIDEBAR -->
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Il s'agit d'un restaurant flottant sur le &quot;Canal das Pirâmides&quot;, a Rossio, Aveiro.Une constrution unique qui se diffère sur l'un des principaux canaux de la ville.<br>
						</p>
              </div>
			</div>
		...
		<!-- WIDGET -->
			<div class="sidebar-item  m-bot-25">
				...
				<div class="under-box-bg"></div>
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5"><br>
						<li>LONGUEUR: 25,00 m</li><br>
						<li>BOUCHE: 5,00 m</li><br>
						<li>TIRANT D'EAU: 0,75 m</li><br>
                        <li>VITESSE DE CROISIÈRE:<br>
                          Sans propulsion <br>
                        </li>
                        <br>
					</ul>
