...
<html>
 	<head>
		<title>Navalria | Port Tejo</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE RÉPARATION <span class="sub-title">/ PORT TEJO</span></h1>
				<ul class="portfolio-pagination">
				  <li>
						<a class="pag-prev" href="ptf_AreiaMar"></a>
					</li>
					<li>
						<a class="pag-next" href="ptf_Sagitarius"></a>
					</li>
				</ul>
			</div>	
		</div>
			...
			<div class="blog-item m-bot-25">
				<div class="content-container-white">
					<div class="view view-first">
						<img src="images/portfolio/PortTejo/01.jpg"alt="Port Tejo" >
					</div>
				</div></div>
                ...
                <div class="blog-item m-bot-25">
					...
					<div class="view view-first"><img src="images/portfolio/PortTejo/02.jpg"alt="Port Tejo" ></div></div></td>
                        <td width="25px">&nbsp;</td>
                        <td align="right">&nbsp;</td>
                        </tr>
                        </table>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Le Port Tejo est une embarcation vraquier de charge, propriété de Portline. Cette embarcation est réparée depuis 1995 dans les chantiers de Navalria.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LONGUEUR: 104 m</li>
					 <br>
						<li>BOUCHE: 16,5 m</li>
						<br>
						<li>TIRANT D'EAU: 6 m</li>
						<br>
						<li>DÉPLACEMENT: 1 700 t</li>
						<br>
					</ul>
				</div>
			</div>	
