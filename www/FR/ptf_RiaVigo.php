	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE RÉPARATION <span class="sub-title">/ RIA DE VIGO</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Le Ria de Vigo, une remorque de haute mer propriété de Remolcanosa est réparée chez Navalria depuis plus de 5 ans.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LONGUEUR: 90 m</li>
					 <br>
						<li>BOUCHE: 14 m</li>
						<br>
						<li>TIRANT D'EAU: 7 m</li>
						<br>
					</ul>
				</div>
			</div>	
