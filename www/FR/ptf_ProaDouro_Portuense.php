...
<html>
 	<head>
		<title>Navalria | Proa Douro et Portuense</title>
		<meta charset=utf-8 >
	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE CONSTRUCTION <span class="sub-title">/ PROA DOURO ET PORTUENSE</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Construites pour l'entreprise Via Douro, ces deux embarcations, au contraire des « rabelos » traditionnels sont construit en acier.  Cette construction assure l'accomplissement des exigences de résistances au feu ce qui fait que sa réparation soit plus économique et rapide.</p>
						<p>D'autre part, la construction en acier permet que les bateaux soient plus lèges et ainsi plus écologiques, une fois qu'ils diminuent la consommation de carburant.</p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>PROJET: CNV Naval Architects </li><br>
						<li>LONGUEUR TOTALE: 19,00 m</li><br>
						<li>LONGUEUR EP.: 15,00 m</li><br>
						<li>BOUCHE EXT.: 4,00 m </li><br>
                        <li>TIRANT D'EAU MAX. (Design slwl): <br/>0,60 m</li>
                        <br>
                        <li>CAPACITÉ: 45  passagers</li><br>
					</ul>
				</div>
			</div>	
