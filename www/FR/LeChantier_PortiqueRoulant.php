       ...
       <div class="in-sixteen in-columns"><p><h1>Le Chantier</h1></p>
				...
				<div class="row">
					...
					<div class="in-one-third in-column">
						<P><h4>Portique roulant</h4></P>
						<p>
                            <strong>CAPACITÉ:</strong> 80 t<br/>
                            <strong>DIMENSIONS:</strong> Hauteur - 15 m; Largeur - 50 m<br/>
                            <strong>PRINCIPAUX AVANTAGES:</strong> Installé en 2013, le portique roulant a permis à Navalria une meilleure flexibilité dans le déplacement des pièces, en optimisant les travaux de construction navale.
					</p>
                    <p>&nbsp;<br/><a href="LeChantier">&lt; retour</a></p></div>
