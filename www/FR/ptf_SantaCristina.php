	...
	<div class="container m-bot-15 clearfix">
		<div class="sixteen columns">
			<div class="page-title-container clearfix">
				<h1 class="page-title">PORTEFEUILLE DE RÉPARATION <span class="sub-title">/ SANTA CRISTINA</span></h1>
		...
		<!-- WIDGET -->	
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
						...
						<p>Navalria a été un partenaire de confiance de l'industrie morutière. Un des exemples est le morutier Santa Cristina, qui est réparé dans nos ateliers depuis 1990.  </p>
              </div>
			</div>
			...
			<div class="sidebar-item  m-bot-25">
				...
				<div class="content-container-white padding-l-r-15">
					<ul class="styled-list style-5">
					 <br> <li>LONGUEUR: 89 m</li>
					 <br>
						<li>BOUCHE: 14 m</li>
						<br>
						<li>TIRANT D'EAU: 5,5 m</li>
						<br>
						<li>DÉPLACEMENT: 1 600 t</li>
						<br>
					</ul>
				</div>
			</div>	
